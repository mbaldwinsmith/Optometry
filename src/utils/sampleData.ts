...
BLK-88201,Fairhaven Care Home,CB25 9EJ,24/08/2026,14/03/1938,Dr. Emma Taylor MCOptom,Melanie,Dudman,Yes,,NHS,+0.50,-0.75,180,+2.50,+0.50,-0.75,90,+2.50,64,SOS advice given. Change in near Rx. Dist: Solo 837 purple 52 with MAR. Near: Solo 226 bronze flex hinge. Distance PDs 32 R+L.
BLK-88202,Fairhaven Care Home,CB25 9EJ,24/08/2026,22/11/1942,Dr. Emma Taylor MCOptom,Arthur,Pendleton,Yes,,NHS,+1.75,-0.50,90,+2.50,+2.00,-0.50,85,+2.50,65,SOS advice given. New reading pair issued. Dist: Existing kept in good order. Near: Solo 114 silver metal. Distance PD 65.
...
BLK-88204,Fairhaven Care Home,CB25 9EJ,24/08/2026,18/07/1940,Dr. Emma Taylor MCOptom,Geoffrey,Harris,Yes,,Private,+0.75,DS,-,+2.25,+1.00,DS,-,+2.25,63,Private patient. Both pairs ordered. Dist: Trendline 901 Tortoise with MAR. Near: Trendline 901 Gold flex. Patient and family delighted.
BLK-88205,Fairhaven Care Home,CB25 9EJ,24/08/2026,30/01/1936,Dr. Emma Taylor MCOptom,Beatrice,Welling,Yes,,NHS,+2.25,-1.25,15,+2.50,+2.50,-1.00,165,+2.50,62,SOS advice given. Bifocal spectacles issued. Bifocal: Stepper SI 6012 Titanium Wine with Reactions. Clear instructions provided to care staff.
...
BLK-88207,Fairhaven Care Home,CB25 9EJ,24/08/2026,09/04/1939,Dr. Emma Taylor MCOptom,Florence,Nightingale,Yes,,NHS,-1.50,DS,-,+2.50,-1.75,DS,-,+2.50,60,SOS advice given. Clear distance vision with current frame. Issued replacement reading pair. Near: Solo 208 Soft Teal.
...
export function generateCsvTemplate(): string {
  ...
  const row1 = 'BLK-88201,Fairhaven Care Home,CB25 9EJ,24/08/2026,14/03/1938,Dr. Emma Taylor MCOptom,Melanie,Dudman,Yes,,NHS,+0.50,-0.75,180,+2.50,+0.50,-0.75,90,+2.50,64,SOS advice given. Dist: Solo 837 purple 52 with MAR. Near: Solo 226 bronze flex hinge.';
