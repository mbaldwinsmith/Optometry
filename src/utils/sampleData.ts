export const SAMPLE_OPTOMETRY_CSV = `Blink ID,Care Home,Post Code,Examination Date,DOB,Optometrist,Resident First Name,Resident Surname,Seen?,Reason not seen,Funding,Right SPH,Right CYL,Right Axis,Right Near Add,Left SPH,Left CYL,Left Axis,Left Near Add,Distance PD,Notes
...
BLK-88205,Fairhaven Care Home,CB25 9EJ,24/08/2026,30/01/1936,Dr. Emma Taylor MCOptom,Beatrice,Welling,Yes,,NHS,+2.25,-1.25,15,+2.50,+2.50,-1.00,165,+2.50,62,SOS advice given. GOS 3 issued for bifocal spectacles. Frame: Stepper SI 6012 Titanium Wine. Clear instructions provided to care staff.
